...
# path to data
path_data = "/home/bertinelli/pod_compastro23/Fireworks/fireworks_test/data/ass_3/"
...
def update_pos(frame): 
    ...
    ax.scatter(intr[0,0], intr[0,1], color="tab:red", s=100, marker="x", zorder=10, label="Initial Position")
    ax.scatter(intr[0,2], intr[0,3], color="tab:red", s=100, marker="x", zorder=10)
