...
public:
    ...
    virtual bool check_stopping_condition(ch_real3 *pos, ch_real3 *vel, ch_real *mass, ch_real *rad, ch_real time) {return false;};
...
public:
    ...
    bool check_stopping_condition(ch_real3 *pos, ch_real3 *vel, ch_real *mass, ch_real *rad, ch_real time) override;
