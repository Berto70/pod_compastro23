...
public:
	...
	void initialize_pinfo(pinfo *xdata, ch_real *rads, ch_real *mass, size_t Npart);
...
public:
    ...
    void initialize_angmom(ch_real3 *pos, ch_real3 *vel, ch_real *mass, size_t id1, size_t id2)  {
    ...
    bool triple_stopcond(ch_real3 *pos, ch_real3 *vel, ch_real *mass, double current_time);

    double compute_hangle(ch_real3 *pos, ch_real3 *vel, size_t id1, size_t id2);
    ...
    static double compute_ffactor(PairOrbit &Inner, PairOrbit &Outer, ch_real3 *pos, ch_real *mass);
...
private:
    ...
    bool critical_orbit(PairOrbit *a_e_vdotr, ch_real3 *pos, size_t Npairs);

    bool check_unbound_system(ch_real3 *pos, ch_real3 *vel, ch_real *mass);

    bool check_bound_binary(PairOrbit &Inner, ch_real3 *pos, ch_real3 *vel, ch_real *mass);

    bool is_stable_hierarchical_triple(PairOrbit &Inner, PairOrbit &Outer, ch_real3 *pos, ch_real3 *vel, ch_real *mass);
    bool is_interacting_binary_single(PairOrbit &Inner, PairOrbit &Outer, ch_real3 *pos, ch_real3 *vel, ch_real *mass);

    void compute_orbit_properties(PairOrbit &Inner, PairOrbit &Outer, ch_real3 *pos, ch_real3 *vel);

    void print_coord(ch_real3 *pos, ch_real3 *vel, ch_real *mass, size_t N);
};
