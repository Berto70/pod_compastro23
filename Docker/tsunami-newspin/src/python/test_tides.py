...
ax[2].plot(tnb, spin1nb, alpha=0.66, label="$\Omega_1$")
ax[2].plot(tsec, spin1sec, alpha=0.66, ls="--", c="tab:blue")
ax[2].plot(tnb, spin2nb, alpha=0.66, label="$\Omega_2$")
ax[2].plot(tsec, spin2sec, alpha=0.66, ls="--", c="tab:orange")
ax[2].plot(tsec, n, alpha=0.66, c="black", ls=":", label="$n$")
ax[2].plot(tsec, necc, alpha=0.66, c="green", ls=":", label="$n_{\\rm ecc}$")
ax[2].plot(tsec, nsync, alpha=0.66, c="red", ls=":", label="$n_{\\rm p\hbox{-}s}$")
ax[2].set_ylabel("angular frequency [rad/yr]")
ax[2].set_yscale("log")
ax[2].legend(loc="lower right", ncols=2)

ax[3].plot(tnb, obl1nb, alpha=0.66, label="$\\theta_1$")
ax[3].plot(tsec, obl1sec, alpha=0.66, ls="--", c="tab:blue")
ax[3].plot(tnb, obl2nb, alpha=0.66, label="$\\theta_2$")
