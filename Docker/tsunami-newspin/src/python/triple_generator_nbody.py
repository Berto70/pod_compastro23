...
class TripleSystemNbody(TripleSystem):
    ...
    def __init__(self,
        ...
        self.pn1 = self.gr and self.directcode.Conf.pn1
        self.pn2 = self.gr and self.directcode.Conf.pn2
        self.pn3 = self.gr and self.directcode.Conf.pn3
    ...
    def create_nbody_ic(self, m1, m2, m3,
        ...
        minn = m1 + m2
        pos_vel1 = self.KU.kepl_to_cart(pos_vel2, m1, m2, a1, e1, i1, ome1, Ome1, nu1)
        ...
        mout = m1 + m2 + m3
        pos_vel3 = self.KU.kepl_to_cart(np.array([0., 0., 0., 0., 0., 0.]),
                                          minn, m3, a2, e2, i2, ome2, Ome2, nu2)
