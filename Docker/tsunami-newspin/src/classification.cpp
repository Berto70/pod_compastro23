...
void Classification::initialize_pinfo(pinfo *xdata, ch_real *rads, ch_real *mass, size_t Npart) {
...
void TripleClass::print_coord(ch_real3 *pos, ch_real3 *vel, ch_real *mass, size_t N) {
...
bool TripleClass::triple_stopcond(ch_real3 *pos, ch_real3 *vel, ch_real *mass, double current_time) {
    size_t N = 3;
...
bool TripleClass::critical_orbit(PairOrbit *a_e_vdotr, ch_real3 *pos, size_t Npairs) {
...
bool TripleClass::check_unbound_system(ch_real3 *pos, ch_real3 *vel, ch_real *mass) {
    size_t N = 3;
...
bool TripleClass::check_bound_binary(PairOrbit &Inner, ch_real3 *pos, ch_real3 *vel, ch_real *mass) {
...
bool TripleClass::is_stable_hierarchical_triple(PairOrbit &Inner, PairOrbit &Outer, ch_real3 *pos, ch_real3 *vel,
                                                ch_real *mass) {
    if (Inner.mardl_stable(Outer)) {
        ...
        if (status != sys::ISINTERACTING_BOUND_BINSINGLE or rapid_exchange) {
            ...
            //ch_real3 r = (Inner.pcom - pos[Outer.i]);
...
bool TripleClass::is_interacting_binary_single(PairOrbit &Inner, PairOrbit &Outer, ch_real3 *pos,
                                               ch_real3 *vel, ch_real *mass) {
...
double TripleClass::compute_hangle(ch_real3 *pos, ch_real3 *vel, size_t id1, size_t id2) {
...
double TripleClass::compute_ffactor(PairOrbit &Inner, PairOrbit &Outer, ch_real3 *pos, ch_real *mass) {
...
void TripleClass::compute_orbit_properties(PairOrbit &Inner, PairOrbit &Outer, ch_real3 *pos, ch_real3 *vel) {
