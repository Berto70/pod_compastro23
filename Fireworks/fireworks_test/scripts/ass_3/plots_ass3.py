...
# Load data
ic_param = np.genfromtxt('ext_volume/pod_compastro23/Fireworks/fireworks_test/data/ass_3/ic_param.txt')
mass1 = ic_param[0]
mass_2 = ic_param[1]
rp = ic_param[2]
e = ic_param[3]
...
pos_i = np.load('ext_volume/pod_compastro23/Fireworks/fireworks_test/data/ass_3/pos_i.npy', allow_pickle=True)
vel_i = np.load('ext_volume/pod_compastro23/Fireworks/fireworks_test/data/ass_3/vel_i.npy', allow_pickle=True)
acc_i = np.load('ext_volume/pod_compastro23/Fireworks/fireworks_test/data/ass_3/acc_i.npy', allow_pickle=True)
mass_i = np.load('ext_volume/pod_compastro23/Fireworks/fireworks_test/data/ass_3/mass_i.npy', allow_pickle=True)
Etot_i = np.load('ext_volume/pod_compastro23/Fireworks/fireworks_test/data/ass_3/Etot_i.npy', allow_pickle=True)
...
plt.savefig('ext_volume/pod_compastro23/Fireworks/fireworks_test/plots/ass_3/pos_vel_plot.pdf')
...
plt.savefig('ext_volume/pod_compastro23/Fireworks/fireworks_test/plots/ass_3/Etot.pdf')
