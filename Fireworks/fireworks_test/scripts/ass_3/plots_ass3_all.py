...
ic_param = np.genfromtxt(path + '/data/ass_3/ic_param_all_e_0.9_rp_0.1.txt')
mass_1 = ic_param[0]
mass_2 = ic_param[1]
rp = ic_param[2]
e = ic_param[3]
...
data_00001 = np.load(path + '/data/ass_3/dt_0.0001_e_0.9_rp_0.1.npz', allow_pickle=True)
data_0001 = np.load(path + '/data/ass_3/dt_0.001_e_0.9_rp_0.1.npz', allow_pickle=True)
data_001 = np.load(path + '/data/ass_3/dt_0.01_e_0.9_rp_0.1.npz', allow_pickle=True)
